...
class MMG(gym.Env):
    ...
    def __init__(self, 
        ...
        self.actions = [
            {'idx': 0, 'module': 'x',   'feature': 'x_position'}, 
            {'idx': 1, 'module': 'y',   'feature': 'y_position'},
            {'idx': 2, 'module': 'psi', 'feature': 'heading_angle'}, 
            {'idx': 3, 'module': 'u',   'feature': 'surge_velocity'}, 
            {'idx': 4, 'module': 'v',   'feature': 'sway_velocity'}, 
            {'idx': 5, 'module': 'r',   'feature': 'yaw_velocity'} ]
